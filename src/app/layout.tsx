...
export const metadata: Metadata = {
  title: "BaseSeek",
  description: "BaseSeek – AI search engine for the Base ecosystem powered by Gemini Free API.",
      ...
      <body className={`${inter.className} bg-slate-950 text-slate-50`}>
        <div className="min-h-screen">
          ...
          <footer className="border-t border-white/5 px-4 py-6 text-center text-xs text-slate-400">
            Powered by Gemini Free API, DexScreener, BaseScan, Aerodrome. Do your own research.
          </footer>
        </div>
      </body>
    </html>
